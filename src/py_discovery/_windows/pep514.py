...
if sys.platform == "win32":
    ...
    def OpenKeyEx(key: _KeyType, sub_key: str, reserved: int = 0, access: int = 131097) -> HKEYType:  # noqa: ARG001, N802
        return HKEYType()

    def QueryValueEx(__key: HKEYType, __name: str | None) -> tuple[Any, int]:  # noqa: N802
        return "", 0
...
def get_value(key: HKEYType, value_name: str | None) -> str | None:
    try:
